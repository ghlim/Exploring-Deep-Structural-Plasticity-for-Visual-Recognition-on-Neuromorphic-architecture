...
\icmltitlerunning{Exploring Deep Structural Plasticity for Visual Recognition on Neuromorphic Architecture}

\begin{document}

\twocolumn[
\icmltitle{Exploring Deep Structural Plasticity for \\
           Visual Recognition on Neuromorphic Architecture}
...
\icmlauthor{Gi Hyun Lim}{uom}
\icmlauthor{Petrut A. Bogdan}{uom}
\icmlauthor{Oliver Rhodes}{uom}
\icmlauthor{Andrew G. D. Rowley}{uom}
\icmlauthor{Steve B. Furber}{uom}
\icmlauthor{Angelo Cangelosi}{uom}
\end{icmlauthorlist}

% \icmlaffiliation{to}{Department of Computation, University of Torontoland, Torontoland, Canada}
\icmlaffiliation{uom}{Department of Computer Science, University of Manchester, Manchester, United Kingdom}

\icmlcorrespondingauthor{Gi Hyun Lim}{hhmetal@gmail.com, gihyunlim@manchester.ac.uk}
\icmlcorrespondingauthor{Angelo Cangelosi}{angelo,cangelosi@manchester.ac.uk}
...
\icmlkeywords{Structural plasticity, neuromorphic architecture}

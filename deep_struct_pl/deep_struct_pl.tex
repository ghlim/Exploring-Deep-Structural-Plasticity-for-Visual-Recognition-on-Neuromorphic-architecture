...
Figure \ref{fig:evHlayerBest} and \ref{fig:evHlayerAvg} show the evolution of the best and average classification performance with respect to the cases, respectively. In the case of synaptic rewiring without STDP (Case 3), there is no significant difference in performance regarding the number of hidden layers.
